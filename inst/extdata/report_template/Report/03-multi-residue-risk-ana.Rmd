...
```{r year-multi-det-bar-line-echart, fig.cap="各年份多残留检出率折线图与最大多残留检出数柱状图"}
bar_line_echart(
...
```{r year-multi-def-bar-line-echart, fig.cap="各年份多残留超标率折线图与最大多残留超标数柱状图"}
bar_line_echart(
  year_multi, x_var = "year", 
...
```{r quarter-multi-def-bar-line-echart, fig.cap="各季度多残留超标率折线图与最大多残留超标数柱状图"}
bar_line_echart(
  quarter_multi, x_var = "quarter", 
  bar_var = "max_defective_num", line_var = "multi_defective_rate_percent", 
  use_y_upper_bound = TRUE
...
```{r category-multi-det-bar-line-echart, fig.cap="各蔬菜类别多残留检出率折线图与最大多残留检出数柱状图"}
bar_line_echart(
...
```{r category-multi-def-bar-line-echart, fig.cap="各蔬菜类别多残留超标率折线图与最大多残留超标数柱状图"}
bar_line_echart(
  category_multi, x_var = "category", 
  bar_var = "max_defective_num", line_var = "multi_defective_rate_percent", 
  use_y_upper_bound = TRUE
...
```{r category-multi-det-scatter-echart, fig.cap="各蔬菜类别多残留检出率与最大多残留检出数散点图"}
scatter_echart(
  category_multi, 
...
```{r category-multi-def-scatter-echart, fig.cap="各蔬菜类别多残留超标率与最大多残留超标数散点图"}
scatter_echart(
  category_multi, 
...
```{r category-multi-rate-scatter-echart, fig.cap="各蔬菜类别多残留检出率与多残留超标率散点图"}
scatter_echart(
  category_multi, 
...
```{r category-multi-num-scatter-echart, fig.cap="各蔬菜类别最大多残留检出数与最大多残留超标数散点图"}
scatter_echart(
  category_multi, 
...
```{r product-multi-det-scatter-echart, fig.cap="各品种多残留检出率与最大多残留检出数散点图"}
scatter_echart(
  product_multi, 
...
```{r product-multi-def-scatter-echart, fig.cap="各品种多残留超标率与最大多残留超标数散点图"}
scatter_echart(
  product_multi, 
...
```{r product-multi-rate-scatter-echart, fig.cap="各品种多残留检出率与多残留超标率散点图"}
scatter_echart(
  product_multi, 
...
```{r product-multi-num-scatter-echart, fig.cap="各品种最大多残留检出数与最大多残留超标数散点图"}
scatter_echart(
  product_multi, 
...
```{r year-quarter-multi-det-bar-line-echart, fig.cap="各年份各季度最大多残留检出数柱状图与多残留检出率折线图"}
bar_line_echart(
...
```{r year-quarter-multi-def-bar-line-echart, fig.cap="各年份各季度最大多残留超标数柱状图与多残留超标率折线图"}
bar_line_echart(
  year_quarter_multi |> combine_year_quarter(), 
...
```{r year-category-multi-det-bar-line-echart, fig.cap="各年份各蔬菜类别多残留检出率折线图与最大多残留检出数柱状图"}
bar_line_echart(
...
```{r year-category-multi-def-bar-line-echart, fig.cap="各年份各蔬菜类别多残留超标率折线图与最大多残留超标数柱状图"}
bar_line_echart(
  year_category_multi, timeline_var = "year", x_var = "category", 
  bar_var = "max_defective_num", line_var = "multi_defective_rate_percent", 
  use_y_upper_bound = TRUE
...
```{r year-category-multi-det-scatter-echart, fig.cap="各年份各蔬菜类别多残留检出率与最大多残留检出数散点图"}
...
```{r year-category-multi-def-scatter-echart, fig.cap="各年份各蔬菜类别多残留超标率与最大多残留超标数散点图"}
scatter_timeline_echart(
  year_category_multi, timeline_var = "year",
...
```{r year-category-multi-rate-scatter-echart, fig.cap="各蔬菜类别各年份多残留检出率折线图与最大多残留检出数柱状图"}
bar_line_echart(
...
```{r year-category-multi-num-scatter-echart, fig.cap="各蔬菜类别各年份多残留超标率折线图与最大多残留超标数柱状图"}
bar_line_echart(
  year_category_multi, timeline_var = "category", x_var = "year", 
  bar_var = "max_defective_num", line_var = "multi_defective_rate_percent", 
  use_y_upper_bound = TRUE
...
```{r year-product-multi-det-scatter-echart, fig.cap="各年份各品种多残留检出率与最大多残留检出数散点图"}
scatter_timeline_echart(
...
```{r year-product-multi-def-scatter-echart, fig.cap="各年份各品种多残留超标率与最大多残留超标数散点图"}
scatter_timeline_echart(
  year_product_multi, timeline_var = "year", 
...
```{r quarter-category-multi-def-bar-line-echart, fig.cap="各季度各蔬菜类别多残留超标率折线图与最大多残留超标数柱状图"}
bar_line_echart(
  quarter_category_multi, timeline_var = "quarter", x_var = "category", 
  bar_var = "max_defective_num", line_var = "multi_defective_rate_percent", 
  use_y_upper_bound = TRUE
...
```{r quarter-category-multi-det-scatter-echart, fig.cap="各季度各蔬菜类别多残留检出率与最大多残留检出数散点图"}
scatter_timeline_echart(
...
```{r quarter-category-multi-def-scatter-echart, fig.cap="各季度各蔬菜类别多残留超标率与最大多残留超标数散点图"}
scatter_timeline_echart(
  quarter_category_multi, timeline_var = "quarter",
  x_var = "category", y_var = "multi_defective_rate_percent", size_var = "max_defective_num"
)
...
```{r quarter-category-multi-rate-scatter-echart, fig.cap="各蔬菜类别各季度多残留检出率折线图与最大多残留检出数散点图"}
bar_line_echart(
...
```{r quarter-category-multi-num-scatter-echart, fig.cap="各蔬菜类别各季度多残留超标率折线图与最大多残留超标数散点图"}
bar_line_echart(
  quarter_category_multi, timeline_var = "category", x_var = "quarter", 
  bar_var = "max_defective_num", line_var = "multi_defective_rate_percent", 
  use_y_upper_bound = TRUE
...
```{r quarter-product-multi-def-bar-line-echart, fig.cap="各季度各品种多残留超标率与最大多残留超标数散点图"}
scatter_timeline_echart(
  quarter_product_multi, timeline_var = "quarter", 
  x_var = "product", y_var = "multi_defective_rate_percent", size_var = "max_defective_num",
  x_label_width = 1
...
```{r year-quarter-category-multi-det-bar-line-echart, fig.cap="各年份各季度各蔬菜类别多残留检出率折线图与最大多残留检出数柱状图"}
bar_line_echart(
...
```{r year-quarter-category-multi-def-bar-line-echart, fig.cap="各年份各季度各蔬菜类别多残留超标率折线图与最大多残留超标数柱状图"}
bar_line_echart(
  year_quarter_category_multi |> combine_year_quarter() |> factor_dims(timeline, category), 
  timeline_var = "timeline", x_var = "category", 
  bar_var = "max_defective_num", line_var = "multi_defective_rate_percent", 
...
```{r year-quarter-category-multi-det-scatter-echart, fig.cap="各年份各季度各蔬菜类别多残留检出率与最大多残留检出数散点图"}
scatter_timeline_echart(
  year_quarter_category_multi |> combine_year_quarter() |> factor_dims(timeline, category), 
...
```{r year-quarter-category-multi-def-scatter-echart, fig.cap="各年份各季度各蔬菜类别多残留超标率与最大多残留超标数散点图"}
scatter_timeline_echart(
  year_quarter_category_multi |> combine_year_quarter() |> factor_dims(timeline, category),
  timeline_var = "timeline",
  x_var = "category", y_var = "multi_defective_rate_percent", size_var = "max_defective_num",
...
```{r year-quarter-category-multi-rate-scatter-echart, fig.cap="各蔬菜类别各年份各季度多残留检出率折线图与最大多残留检出数柱状图"}
bar_line_echart(
  year_quarter_category_multi |> combine_year_quarter() |> factor_dims(timeline, category),
...
```{r year-quarter-category-multi-num-scatter-echart, fig.cap="各蔬菜类别各年份各季度多残留超标率折线图与最大多残留超标数柱状图"}
bar_line_echart(
  year_quarter_category_multi |> combine_year_quarter() |> factor_dims(timeline, category),
  timeline_var = "category", 
  x_var = "timeline", bar_var = "max_defective_num", line_var = "multi_defective_rate_percent", 
